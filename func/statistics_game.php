...
$stmt->bind_param('iiii', $points, $final, $id_game, $id_team);

$final = 1;//почечаем играла команда в финале или нет  1-да 0-нет
$i=0;
...
$final = 0; //почечаем играла команда в финале или нет 0-нет 1-да
