...
if (null != $login) {
    ...
    if ($id_game > 0) {
        ...
        $qualification =
            ...
            RIGHT JOIN {$dbt_games} G ON G.id = Q.id_game
       ...
       // echo "<a href='limit.php?limit=32&type=random&id={$id_game}'> 32 |</a>";
        ...
        for ($t = 1; $t <= 3; ++$t) {
            ...
            foreach ($q_game as $value) {
                if (1 == $value['round'] and null === $value['s1']) {
                    $r1 = true;
            ...
            foreach ($q_game as $value) {
                if (2 == $value['round'] and null === $value['s1']) {
                    $r2 = true;
            ...
            foreach ($q_game as $value) {
                if ($value['round'] == $round[$t]) {
                    ...
                    if (null == $value['s1'] and null == $value['s2']) {
                        echo "<td>
